...
test: ## Run the bash harnesses (install, agent-adapters, plugin-registry, Stage 10 focused/integration, loop, swarm, audit, devcontainer, harvest-hive, eval/docs/gate checks, release-index, wsl-boundary)
