...
test: ## Run the bash harnesses (install, loop, swarm, devcontainer, harvest-hive, grade-evals, check-evals, check-docs, check-trailers, check-doc-sync, wsl-boundary)
