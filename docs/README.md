...
| **[Stage 10 offline orchestration](reference/stage10.md)** | Reference | Evidence-first memory, qualification, routing, comparison, local PR handoff, and authority boundaries |
