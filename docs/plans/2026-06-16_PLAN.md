...
**Date:** 2026-06-16 · **Status:** documentation + **Tier 1** shipped (SKILL.md v0.3); **Tier 2 item
#7 (loop limits) shipped** in `feat/roadmap-tier2-loop-limits`; remaining Tier 2–3 in follow-up PRs.
